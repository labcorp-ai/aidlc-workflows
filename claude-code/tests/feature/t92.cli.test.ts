// covers: subcommand:aidlc-sensor:fire
//
// CLI-contract port of tests/feature/t92-sensor-fire.sh (TAP plan 43),
...
describe("t92 Group G: concurrency invariants", () => {
  ...
  test("25: lock-released-across-spawn — fast PASSED lands during slow's spawn window", async () => {
    ...
    await sleep(200);
    // Fast fire backgrounded 200ms later; await its completion.
