...
// scope-exclusion counts. Drive a REAL `/aidlc <scope> --test-run` workflow
// through the Claude Agent SDK (driveAidlc) and assert, as data, that a stage
// marked SKIP-for-this-scope emits ZERO STAGE_STARTED across the WHOLE workflow.
// {sdk} mechanism (the property is audit-count data, not a rendered choice).
//
// WHY THIS IS METAMORPHIC, NOT A t53 CLONE. t53 (tests/workflow/t53.test.ts)
