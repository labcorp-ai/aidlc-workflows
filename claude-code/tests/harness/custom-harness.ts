...
//
// Models what a HARNESS ENGINEER does (docs/harness/00-overview.md): reshape the
...
// stage's produces:), a deterministic check bound to a stage (a custom sensor),
// and a standing rule. "stages are *what*, agents are *who*". "Harness Engineer"
// is a PERSONA / reader role, NOT a scope; the custom scope this fixture seeds is
// a realistic domain workflow: `data-migration`.
//
...
this stage as its origin, per the project rule ${CUSTOM_RULE_MARKER}.
