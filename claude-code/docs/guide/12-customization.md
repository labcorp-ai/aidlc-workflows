...
Scopes control which stages execute and at what depth and test strategy. AI-DLC provides 9 named scopes:
...
This implementation displays a statusline in the terminal status bar showing workflow progress:
...
|--------------|----------|
| Edit what a stage does, or add a new stage | [Anatomy of a Stage](../harness/01-anatomy-of-a-stage.md), [Adding a Stage](../harness/02-adding-a-stage.md) |
| Add or modify an agent | [Adding an Agent](../harness/03-adding-an-agent.md) |
| Define or tune a scope | [Scopes](../harness/04-scopes.md) |
| Teach a standing rule, or operate the learning loop | [Rules and the Learning Loop](../harness/05-rules-and-the-loop.md) |
| Wire a deterministic check (sensor) into a stage | [Sensors](../harness/06-sensors.md) |
| Add team domain knowledge | [Team Knowledge](../harness/07-team-knowledge.md) |
