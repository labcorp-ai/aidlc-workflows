...
See [Getting Started](01-getting-started.md) for the server registry and credentials, and [Claude Code Features](../reference/14-claude-features.md) for how MCP maps onto Claude Code's native tool model.
