...
// below). A faithful rewrite of tests/stage/t101-stage-memory-lifecycle.sh,
...
// Gated behind AIDLC_TUI_LIVE=1 so a bare `--tui` on a laptop SKIPs it; tmux/
  ...
  test.skipIf(SKIP_REASON !== null)(
    ...
    async () => {
      ...
      try {
        ...
        // 3. the VERBATIM ownership blockquote (.sh assertion 3 — STRONGER:
        //    asserted unconditionally, not skip-when-approximated). A malformed
        //    or missing header is a real fidelity defect, not LLM variance.
